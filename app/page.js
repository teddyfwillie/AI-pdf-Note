...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-indigo-50">
      {/* Navigation */}
      <nav className="flex justify-between items-center px-8 py-6 bg-white/80 backdrop-blur-sm">
        <div className="flex gap-8 items-center">
          <BrainCircuitIcon className="h-7 w-7 text-indigo-600" />
          <div className="flex gap-6 text-sm font-medium text-slate-600">
            ...
            <span className="hover:text-indigo-600 cursor-pointer">FAQ</span>
          </div>
        </div>
